...
@WebFilter(filterName = "LogCostFilter", urlPatterns = {"/*"},
        initParams = {@WebInitParam(name = "ignoredUrl", value = ".ico"),
                      @WebInitParam(name = "filterPath",
                              value = "/fc-boot/user/login#/fc-boot/user/registerUser#/fc-boot/user/randomImage#" +
                                      "/fc-boot/platformConfig/getPlatform#/fc-boot/v2/api-docs#/fc-boot/webjars#" +
                                      "/fc-boot/systemConfig/static")})
